...
export const SectionHighlight: React.FC<SectionHighlightProps> = ({
    ...
    return (
        <div
            className={`flex-wrap md:flex-nowrap w-full space-x-11 rounded-xl items-center py-[60px] px-6 space-y-6 md:space-y-0 md:py-[120px] md:px-12 ${backgroundClass} bg-gradient-to-b`}
        >
