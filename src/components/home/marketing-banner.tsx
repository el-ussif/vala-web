            ...
            <div className="container w-full  px-2 md:px-0">
                ...
                <div
                    ...
                    <PillBadge
                        ...
                        label="PCS Moves"
                    />
                    <span className="text-2xl">, manage your</span>
                    <PillBadge
                        ...
                        label="Family Life"
                    />
                    <span className="text-2xl">plan your</span>
                    <PillBadge
                    ...
                    />
                    <span className="text-2xl">and explore your path with</span>
                    <PillBadge
                    ...
                    />
                    <span className="text-2xl">— all in one place.</span>
                </div>
                <div className="w-full justify-center my-20 flex">
                    <CallActionButton/>
                </div>
            </div>
        </div>
